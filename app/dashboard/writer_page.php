...
<? if($book->id == 1){ ?>
<span class="page_title">Writers Page</span><br /><br /><br />
...
<div class="conte_banners" style="font-size:12px;">
        ...
        <input name="brand" type="hidden" id="brand" value="1" />
        <input name="category" type="hidden" id="category" value="<? echo $category->id ?>" />
      ...
      <br /><br />      
      <strong><a href="javascript:;" onclick="writers_preview('<? echo $current_affiliate->id ?>');" class="normal_link">Click here for Preview</a></strong>
      <br /><br />
      <input onclick="generate_writers_code('<? echo $current_affiliate->id ?>');" name="" type="button" value="Generate Code" />
      <br /><br />
...
<? }else if($book->id == 3){ ?>
	...
	<div class="conte_banners" style="font-size:12px;">
        ...
        <br />
        <input name="aff_books" type="hidden" id="aff_books" value="<? echo $str_books ?>" />
        <input name="brand" type="hidden" id="brand" value="3" />
        <input name="category" type="hidden" id="category" value="<? echo $category->id ?>" />
      <strong>With:</strong> <input name="if_w" type="text" id="if_w" value="900" size="5" /> px&nbsp;&nbsp;&nbsp;
      <strong>Height:</strong> <input name="if_h" type="text" id="if_h" value="1100" size="5" /> px&nbsp;&nbsp;&nbsp;
      <? if($category->id == 1){ ?>
      <?php /*?><strong>Default Tab:</strong> 
      <select name="sports" id="sports">
        <option value="sb">Sportsbook</option>
        <option value="rb">Racebook</option>
      </select><?php */?>
      <input name="sports" type="hidden" id="sports" value="sb" />
      <? }else{ ?>
      <input name="sports" type="hidden" id="sports" value="cas" />
      <? } ?>
      &nbsp;&nbsp;&nbsp;
      <br /><br /><strong>Header Banner: </strong>
      <? echo get_campaigns_by_size($campaigns, $top_size, "head_banners", "", false) ?>
