...
<?
if($_POST){
	$path = "../images/affiliates/twitter_logos/";
	$filename = upload_image_partners("logo_file", $path, $current_affiliate->id."_twitter");
	if($filename != ""){$logo_url = "http://localhost:8080/images/affiliates/twitter_logos/" . $filename;}
...
<span class="page_title">Twitter Widget</span><br /><br /><br />

<div class="conte_banners" style="font-size:12px;">
       <div class="conte_banners_header"><strong>Sports Tweets</strong> </div>
        <br />
      <form method="post" action="twitter_widget.php?book=<? echo $book->id; ?>&category=<? echo $category->id; ?>" enctype="multipart/form-data">
      ...
      <tr>
        ...
        <?php /*?><option value="SPORTS_WRITERS">WRITTERS</option><?php */?>
    </select></td>
      </tr>
      <tr>
...
if($_POST){
	?><script type="text/javascript">
		...
		twitter_widget_code('<? echo $current_affiliate->id ?>','<? echo $book->url ?>');
    </script><? 
}
?>