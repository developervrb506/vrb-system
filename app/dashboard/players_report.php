...
<title><? echo $book_name ?> Players Report</title>
...
<span class="page_title"><? echo $book_name ?> Players Report</span><div style="float:right;" class="normal_link"><a href="http://localhost:8080/dashboard/reports.php?bk=<? echo $bookid ?>"><strong><< Back</strong></a></div><br /><br />
<?
$book = $bookid; //Book Id
...
if ($_POST) {
  echo file_get_contents("http://www.sportsbettingonline.ag/utilities/process/reports/vrb_sbo_players_report.php".$data);
}
?>
</div>
