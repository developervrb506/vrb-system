...
<span class="page_title"><? echo $book_name ?> Players Report</span><div style="float:right;" class="normal_link"><a href="<?= BASE_URL ?>/dashboard/reports.php?bk=<? echo $bookid ?>"><strong><< Back</strong></a></div><br /><br />
<?
$book = $bookid; //Book Id
