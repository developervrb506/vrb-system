...
foreach($books as $pbook){
	...
	$campaigns = array_merge($campaigns, search_campaign($pbook, $category));
}
...
<span class="page_title">Betting Lines Page</span><br /><br /><br />
...
<div class="conte_banners" style="font-size:12px;">
      ...
      <br /><br />      
      <strong><a href="javascript:;" onclick="lines_preview_new('<? echo $current_affiliate->id ?>');" class="normal_link">Click here for Preview</a></strong>
      <br /><br />
      <input onclick="generate_lines_code_new('<? echo $current_affiliate->id ?>');" name="" type="button" value="Generate Code" />
      <br /><br />
      
      <div id="code_area" style="display:none;"><br />
      <textarea name="code" cols="90" rows="4" readonly="readonly" id="code"></textarea><br />
