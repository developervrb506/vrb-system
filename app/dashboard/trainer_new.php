...
<div class="conte_banners" style="font-size:12px;">
        ...
        <br />
      <form method="post" action="trainer_new.php?book=<? echo $book->id; ?>&category=<? echo $category->id; ?>" enctype="multipart/form-data">
      ...
      <input name="" type="submit" value="Generate Code" /></form>
      <br /><br />
      <br /><br />
...
<?
if($_POST){
	?><script type="text/javascript">blackjack_trainer_code('<? echo $current_affiliate->id ?>','<? echo $book->url ?>');</script><? 
}
?>