...
<span class="title">Create New Ticket: </span>
<form method="post" action="actions/create.php" id="frm_2">
...
<?php */?>      <? } ?>  
  ...
  <tr>
  	<td></td>
    <td align="right"><input id="btn2" onClick="disable_btn2('btn2')" name="" type="button" value="Submit"></td>
    <td></td>
  </tr>
</table>
</form>
