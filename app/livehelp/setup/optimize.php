<?php
	...
	$stat_begin = time( 0,0,0,$month,$day,$year ) ;
	$stat_end = time( 23,59,59,$month,$day,$year ) ;
	...
	$nextday = time( 0,0,0,$month,$day+1,$year ) ;
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="height:100%">
  ...
  <tr> 
	<td height="20" align="center" class="bgCopyright" style="height:20px">Powered by INSPIN - v<?php echo $PHPLIVE_VERSION ?>INSPIN</td>
  </tr>
</table>
