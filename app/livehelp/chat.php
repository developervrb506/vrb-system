...
<!--
	...
	function messagebox()
	{
		...
		var url = "message_box.php?l=<?php echo $session_chat[$sid]['asp_login'] ?>&x=<?php echo $session_chat[$sid]['aspID'] ?>&deptid=<?php echo $session_chat[$sid]['deptid'] ?>&action=exit&requestid=<?php echo $requestid ?>&sid=<?php echo $sid ?>&ins=<?php echo $ins ?>&agsite=<?php echo $agsite ?>&agsite_desc=<?php echo $agsite_desc ?>&mobile=<?php echo $mobile ?>" ;
		location.href = url ;
	}
...
<frameset rows="<?php echo $frame_row_properties ?>" cols="*" border="0" frameborder="0">
	<frame src="chat_session.php?sessionid=<?php echo $sessionid ?>&sid=<?php echo $sid ?>&requestid=<?php echo $requestid ?>&ins=<?php echo $ins ?>&agsite=<?php echo $agsite ?>&agsite_desc=<?php echo $agsite_desc ?>&mobile=<?php echo $mobile ?>" name="session" noresize border=0 scrolling=no>
	<frame src="chat_main.php?sessionid=<?php echo $sessionid ?>&requestid=<?php echo $requestid ?>&sid=<?php echo $sid ?>&ins=<?php echo $ins ?>&agsite=<?php echo $agsite ?>&agsite_desc=<?php echo $agsite_desc ?>&mobile=<?php echo $mobile ?>&start=1" name="main" noresize border=0 scrolling=no>
</frameset>
</html>
<?php
	mysql_close( $dbh['con'] ) ;
