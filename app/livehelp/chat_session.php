...
<!--
	...
	function do_reload()
	{
		...
		var url = "<?php echo $BASE_URL ?>/pull/chat_session.php?sessionid=<?php echo $sessionid ?>&sid=<?php echo $sid ?>&requestid=<?php echo $requestid ?>&ins=<?php echo $ins ?>&agsite=<?php echo $agsite ?>&agsite_desc=<?php echo $agsite_desc ?>&mobile=<?php echo $mobile ?>&unique="+unique ;
	...
	function xmlsubmit(message)
	{
		...
		var url = "<?php echo $BASE_URL ?>/pull/chat_session.php?action=submit&sessionid=<?php echo $sessionid ?>&sid=<?php echo $sid ?>&ins=<?php echo $ins ?>&agsite=<?php echo $agsite ?>&agsite_desc=<?php echo $agsite_desc ?>&mobile=<?php echo $mobile ?>&message="+message ;
...
<body style="background:#000;" marginheight="0" marginwidth="0" topmargin="0" leftmargin="0" OnLoad="init_session()">
</body></html>
<?php
//	mysql_close( $dbh['con'] ) ;
?>