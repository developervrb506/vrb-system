<?php
				...
				$phone )
	{
		...
		if ( $dbh[ 'ok' ] )
		{
			...
			{
				$query = "INSERT INTO chatrequests VALUES (0, '$userid', '$deptid', '$aspid', '$from_screen_name', $sessionid, '$surveyid', $now, '$status', 0, 0, '$ip', '$browser', '$display_resolution', '$visitor_time', '$email', '$page', '$question', '$phone')" ;
				database_mysql_query( $dbh, $query ) ;
