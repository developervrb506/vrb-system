<?php
						...
						$get_all )
	{
		...
		$query = "SELECT * FROM chatdepartments WHERE aspID = $aspid $all_string ORDER BY deptID ASC" ;
		database_mysql_query( $dbh, $query ) ;
								...
								$userid )
	{
		...
		$query = "SELECT * FROM chatdepartments, chatuserdeptlist WHERE chatdepartments.deptID = chatuserdeptlist.deptID AND chatuserdeptlist.userID = $userid ORDER BY chatdepartments.deptID ASC" ;
		database_mysql_query( $dbh, $query ) ;
