...
<tr>
	...
	<tr>
		...
		<th width="60" class="th1" nowrap align="left">Name</th>
		<th width="5" class="th1">&nbsp;</th>
		<th width="100" class="th1" align="left">Department</th>
		<th width="5" class="th1">&nbsp;</th>
		<th class="th1" align="left">Question</th>
		<th width="5" class="th1">&nbsp;</th>
	...
	<?php
		for ( $c = 0; $c < count( $chat_requests ); ++$c )
		{
			...
			<tr>
				...
				<td width=\"5\">&nbsp;</td>
				<td nowrap align=\"center\"><a href=\"JavaScript:void(0)\" OnClick=\"window.open('$BASE_URL/request.php?action=accept&sessionid=$request[sessionID]&requestid=$request[requestID]&sid=$sid&userid=".$_SESSION['session_admin'][$sid]['admin_id']."&l=".$_SESSION['session_admin'][$sid]['asp_login']."&x=".$_SESSION['session_admin'][$sid]['aspID']."', '$request[created]', 'status=no,scrollbars=yes,menubar=no,resizable=yes,location=no,width=450,height=$chat_win_height,screenX=50,screenY=100')\"><b>ACCEPT</b></a> &nbsp; | &nbsp; <a href=\"JavaScript:parent.window.do_reject($request[requestID], $request[sessionID])\">busy</a></td>
				<td width=\"5\">&nbsp;</td>
			</tr>
			" ;
