...
<div id="maintrans">
	...
	<fieldset>
		<dl>
			<dt>&nbsp;&nbsp;<label for="email"><div style="color:#FFF">Email To</div></label></td>
			<dd class="textbox"><input type="text" size=45 name="email" maxlength="160" id="email"></dd>
		</dl>
		<dl>
			<dt>&nbsp;&nbsp;<label for="message"><div style="color:#FFF">Message</div></label></dt>
			<dd><textarea rows=3 cols=50 name="optmessage" id="message"></textarea></dd>
		</dl>
		<dl>
			<dt></dt><dd><input type="button" value="Email Transcript" OnClick="do_submit()" class="button" name="submitbutton">  &nbsp;&nbsp; <input type="button" class="button" value="Print Transcript" OnClick="doprint()"></dd>
		</dl>
	</fieldset>
</div>
</form>
