...
<tr> 
	...
	<table cellspacing=1 cellpadding=2 border=0 width="100%">
	  ...
	  <tr> 
		...
		<tr>
			<td>Reference</td>
			<td><input name="name" type="text" style="width:100px" size="<?php echo $text_width ?>" maxlength="20" value="<?php echo stripslashes( $cannedinfo['name'] ) ?>"> <i>(example: Greeting)</i></td>
		</tr>
		<tr>
			<td colspan=2><span class="small">HTML not allowed in message.  Please use <a href="JavaScript:open_help( 'commands' )">Commands</a>.</td>
		</tr>
		<tr>
			<td>Message</td>
			<td>
				...
				<span class="hilight">%%operator%%</span> - operator's name<br></td></tr></table>
			</td>
		</tr>
		<tr>
			<td>Department</td>
...
<tr> 
    <td width="100%" height="350" valign="top"> 
	  ...
	  <table cellspacing=1 cellpadding=2 border=0 width="100%">
		...
		<tr> 
			<td>Reference</td>
			<td><input name="name" type="text" style="width:100px" size="<?php echo $text_width ?>" maxlength="20" value="<?php echo $cannedinfo['name'] ?>"> <i>(example: PUSH demo)</i></td>
		</tr>
		<tr>
			<td><a href="JavaScript:open_help( 'commands' )">Command</a></td>
