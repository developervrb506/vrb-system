...
<link rel="stylesheet" href="https://sportsbettingonline.ag/utilities/css/style.css?ck=11" type="text/css" media="screen" />
...
<div class="wrapper1" id="desk_version" style="display:none;">
  ...
  <div class="wrapper-med">
    ...
    <?php /*?><div><a style="color:#0236a6; cursor:pointer;" href="javascript:;" onclick="Javascript:window.open('https://livechat.vrbmarketing.com/content/live_chat.php?site=<? echo $site_url_chat ?>&amp;withaccount=1','livehelp','width=380,height=500,menubar=no,location=no,resizable=no,scrollbars=no,status=no');return(false);" title="LIVE HELP"><img src="https://sportsbettingonline.ag/utilities/imgs/live-chat3.png" width="84" height="78" /></a></div><?php */?>  
    
    <div class="container-top-contact-button">
        <div class="logo-chat-top"><a style="color:#0236a6; cursor:pointer;" href="javascript:;" onclick="Javascript:window.open('https://livechat.vrbmarketing.com/content/live_chat.php?site=<? echo $site_url_chat ?>&amp;withaccount=1','livehelp','width=380,height=500,menubar=no,location=no,resizable=no,scrollbars=no,status=no');return(false);" title="LIVE HELP"><img src="https://sportsbettingonline.ag/utilities/imgs/live-chat3.png" width="84" height="78" /></a></div>
        <div class="logo-ticket-top"><a style="color:#0236a6; cursor:pointer;" href="javascript:;" onclick="Javascript:window.open('https://livechat.vrbmarketing.com/send_email.php?site=<? echo $site_url_chat ?>','livehelp','width=597,height=560,menubar=no,location=no,resizable=no,scrollbars=no,status=no');return(false);" title="LIVE HELP"><img src="https://sportsbettingonline.ag/utilities/imgs/ticket-alert3.png" width="84" height="78" /></a></div>
        <br /><br /><br />
        <div class="cu-top">Customer Service: 1-877-238-3665</div>
      </div> 
		  ...
		  <div class="container_top_login_box" align="right">
			...
			<form name="LoginForm" action="javascript:void(0)" onsubmit="BackEndLogin(this); return false" id="betslip_login_form"> 
			  ...
			  <table width="360" border="0" cellspacing="0" cellpadding="4">
                <tbody>
                  <tr>
                    <td align="right"><input <? if($use_register){ ?>style="width:155px !important;"<? }else{ ?> style="width:152px !important;" <? } ?> tabindex="1" class="bk_top_login_field bk_top_login_field_username" name="username" type="text" id="username" placeholder="Username"></td>
                    <td align="right"><input <? if($use_register){ ?>style="width:155px !important;"<? }else{ ?> style="width:152px !important;" <? } ?> tabindex="2" class="bk_top_login_field <? if(!$use_register){ ?>bk_top_login_field_password <? } ?>"  name="password" type="password" id="password" placeholder="Password"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td align="right"><table class="table-buttons-top" cellspacing="0" cellpadding="3">
                        ...
                        <td rowspan="2" valign="top" align="right">
						  <? if($use_register){ ?>
                           <a class="join-now-adjust" tabindex="8" href="https://signup.isppro.net/signup?domain=<? echo $site_url_chat ?>&lang=en">JOIN NOW</a>
                          <? } ?>
                        </td>
                        </tr>
                        <tr>
                      ...
                      <? }  else { ?>
                       <tr>
                        ...
                        <a class="agent-billing" tabindex="6" href="javascript:;" onClick="open_billing();"> AGENT BILLING</a><br /><? if($use_register){ ?>
                           <a class="join-now-adjust" tabindex="8" href="https://signup.isppro.net/signup?domain=<? echo $site_url_chat ?>&lang=en">JOIN NOW</a>
                          <? } ?>
