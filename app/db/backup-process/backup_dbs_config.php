...
$BACKUP_NAME = 'db_backups_betting_acco_tickets_' . date('Y-m-d_Hi');
...
$EXCLUDE_DB = 'information_schema, cphulkd, eximstats, horde, leechprotect, logaholicDB_aff, mysql, modsec, roundcube, sportsbe_contacts, vrbmarke_affiliates, vrbmarke_ckuser, vrbmarke_livehelp';
