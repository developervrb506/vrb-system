...
if($brand == 1){
	...
	$bot_banner = $_GET["pid_bot"];
	$aid = $_GET["aid"];
	$result = file_get_contents("http://www.sportsbettingonline.ag/utilities/process/water-cooler/widget/page.php?le=$league&aid=$aid&pid_top=$top_banner&pid_bot=$bot_banner&tp=$type");
	echo $result;
}
?>