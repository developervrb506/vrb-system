...
<? $expenses =  get_current_predefined_office_expenses(); ?>
  ...
  <form method="post" onsubmit="" action="process/actions/add_predefined_expense_action.php" id="frm_ex" >
        
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    
    <td class="table_header" align="center">Select</td>
    ...
    <td class="table_header" align="center">Month/Year</td>
    </tr>
  <?
  $i=0;
  $total = 0;
  ...
  <tr>
     <td class="table_td<? echo $style ?>" align="center">
      <input checked="checked" name="sel_<? echo $ex->vars["id"] ?>" type="checkbox" id="sel_<? echo $ex->vars["id"] ?>" value="1" />
     </td>
