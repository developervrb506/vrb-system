...
<span class="page_title">Michael's Expenses Report</span><br /><br />
...
<div class="form_box">
    ...
    &nbsp;&nbsp;    
    Category: <? include("includes/dj_expenses_categories_list.php"); ?>&nbsp;&nbsp;
...
<? if(isset($_POST["month_from"])){ ?>
	<? $expenses = search_dj_expenses(clean_get("month_from"),clean_get("year_from"), clean_get("month_to"), clean_get("year_to"), $s_cat, $s_status, $s_type); ?>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td class="table_td<? echo $style ?>" align="center">
            <a href="insert_dj_expense.php?ex=<? echo $ex->vars["id"]; ?>&report=1" class="normal_link" rel="shadowbox;height=420;width=405">Edit</a>
        </td>
      </td>
      <? } ?>
      <tr>
