...
<span class="page_title">Special Payouts</span>

<? 
$trans = search_special_payouts_for_process($from, $to, $status, "ac");
$players = "";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td class="table_td<? echo $style ?>" align="center">
		...
		<img id="umki_<? echo "SP" . $tran->vars["id"] ?>" src="https://www.ezpay.com/images/icons/important_vrb.png" width="20" height="20" alt="/" title="Insert Payout">
		</a>
		<img id="mki_<? echo "SP" . $tran->vars["id"] ?>" src="https://www.ezpay.com/images/icons/complete_vrb.png" width="20" height="20" alt="/" title="Paid" style="display:none;">
    </td>
    ...
    <td class="table_td<? echo $style ?>" align="center">
    	<form method="post" action="process/actions/deny_special_payout.php" onsubmit="return confirm('Are you sure you want to Deny this Payout?')">
