...
<title>Calling <? echo $name->full_name(); ?></title>
...
<span class="page_title">Calling <? echo $name->full_name(); ?></span>&nbsp;&nbsp;&nbsp;
...
<table width="100%" border="0" cellspacing="0" cellpadding="10" style="font-size:16px;">
  <tr>
    <td valign="top"><strong>Full Name:</strong><br /><? echo $name->full_name(); ?></td>
