...
<span class="page_title">SEO Articles</span><br /><br />

<? include "includes/print_error.php" ?>

<a href="seo_new_article.php" class="normal_link">New Article</a>

<br /><br />
<?
$lists = get_all_seo_articles();
?>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td class="table_header">Article</td>
