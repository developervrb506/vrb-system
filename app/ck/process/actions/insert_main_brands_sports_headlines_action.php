...
if (isset($_GET["id"])){
	...
	$bunnyCDNStorage->deleteObject("/sbodata/headlines/".$headline->vars["image"].".jpg");	
}
else{
	if (isset($_POST["update"])){
		
		$headline = get_main_brands_sports_headline($_POST["update"]);
...
header("Location: http://localhost:8080/ck/main_brands_sports_headlines.php?e=82");
?>
