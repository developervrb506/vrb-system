...
if(!is_null($trans)){		
	...
	//CRM insertion
	/*$CRMdesc = "Money Order Payout has been Denied. Id: ".$trans->vars["id"];
	$CRMdesc .= "\n Notes: \n";
	...
	rec_process($trans->vars["id"], "Money Order", "Payout", $trans->vars["player"], $trans->vars["amount"], $pre_status, $trans->vars["status"], $current_clerk->vars["id"], $trans->vars["back_message"]);
