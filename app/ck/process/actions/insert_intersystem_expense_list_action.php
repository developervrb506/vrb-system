...
for($i=0;$i<count($amounts);$i++){
	...
	$exp->vars["note"] = clean_get("note").". Moneypak Id:".$mpk;
	...
	$res = inertsystem_insertion(clean_get("system_list_from"), clean_get("from_account"), $amount, $type, "Intersystem Expense #".$exp->vars["id"]." / ".clean_get("note"));
