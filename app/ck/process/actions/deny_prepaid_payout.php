...
<?
$trans = get_prepaid_payout($_POST["id"]);
if(!is_null($trans)){
	...
	//CRM insertion
	/*$CRMdesc = "Prepaid Giftcard Payout has been Denied. Id: ".$trans->vars["id"];
	$CRMdesc .= "\n Notes: \n";
	...
	rec_process($trans->vars["id"], "Prepaid", "Payout", $trans->vars["player"], $trans->vars["amount"], $pre_status, $trans->vars["status"], $current_clerk->vars["id"], $trans->vars["back_message"]);
	
	header("Location: http://localhost:8080/ck/prepaid_payouts.php");
}
?>
