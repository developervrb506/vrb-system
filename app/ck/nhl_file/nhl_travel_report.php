...
<img src="images/NHL.png" style="width:60px; margin-bottom:-20px"><span class="page_title">&nbsp;&nbsp;&nbsp;TEAMS TRAVEL REPORT</span><br /><br /><br />
<?	

if($current_clerk->vars['id'] != 86 ){
	$subject = 'NHL REPORT ACCESS';
...
if ($str_teams == "" && $other != "" ){?>
 ...
 foreach($selected_teams as $steam){
	...
	<?php /*?>	<td class="table_td<? echo $style ?>_yellow first " align="center"></td>        
		...
		<td class="table_td<? echo $style ?>_blue second " align="center"><? if($valid){ echo number_format((100*$s_total/$valid),2); } ?>%<span style="font-size:14px;color:Green"><strong>W</strong></span></td>   <?php */?>                     
