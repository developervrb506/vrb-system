...
<script type="text/javascript" src="<?= BASE_URL ?>/ck/nhl_file/js/functions.js"> </script>
...
if ($str_teams == "" && $other != "" ){?>
 ...
 foreach($selected_teams as $steam){
   ...
   <div id="div_team_<? echo $teams[$st]->vars["id"] ?>"> 
    <div>
       <img style="width:35px" src="<?= BASE_URL ?>/ck/nhl_file/images/<? echo $teams[$st]->vars["logo"]?>.png">
