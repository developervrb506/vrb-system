...
$search_criterias = "&start_date=".$start_date."&dietary_type=".$dietary_type."&payment_status=".$payment_status."&status=".$status."&hear=".$hear."&completed=".$completed."&id_list=".$id_list."&search=".$search."&show_all=".$show_all;
?>
...
<? echo @file_get_contents("http://www.costaricaanimalrescuecenter.org/utilities/ui/coordinators/list.php?&p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING'].$data.$search_criterias.$pagenumber); ?>
