...
<title>Volunteers Preview Step 1</title>
...
<? $data = "&cid=".$current_clerk->vars['id']."&clerk=".str_replace(" ","_",$current_clerk->vars['name'])."&pg=vp"; ?>
<? echo @file_get_contents("http://www.costaricaanimalrescuecenter.org/utilities/ui/volunteers/list-preview.php?&p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING'].$data.$search_criterias.$pagenumber); ?>
