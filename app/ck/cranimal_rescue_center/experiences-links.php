...
<title>Volunteer Experiences Links</title>
...
<h1>Volunteer Experiences Links</h1>
<?
$id  = $_GET["id"]; 
$add = $_GET["add"]; 
...
echo @file_get_contents("http://www.costaricaanimalrescuecenter.org/utilities/ui/experiences-links/list.php?&p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING'].$id.$add); ?>
