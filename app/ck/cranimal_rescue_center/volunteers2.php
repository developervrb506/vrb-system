...
$search_criterias = "&start_date=".$start_date."&dietary_type=".$dietary_type."&payment_type=".$payment_type."&payment_status=".$payment_status."&status=".$status."&promo_code=".$promo_code."&hear=".$hear."&completed=".$completed;

?>
<div class="page_content" style="padding-left:10px;">
<? $data = "&cid=".$current_clerk->vars['id']."&clerk=".str_replace(" ","_",$current_clerk->vars['name'])."&pg=v"; ?>
<? echo file_get_contents("https://www.costaricaanimalrescuecenter.org/utilities/ui/volunteers/list2.php?p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING'].$data.$search_criterias.$pagenumber); ?>
