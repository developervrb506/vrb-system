...
$search_criterias = "&visit_date=".$visit_date."&payment_type=".$payment_type."&payment_status=".$payment_status."&status=".$status."&include_meal=".$include_meal."&completed=".$completed."&id_list=".$id_list."&search=".$search."&show_all=".$show_all;

?>
<div class="page_content" style="padding-left:10px;">
<? $data = "&cid=".$current_clerk->vars['id']."&clerk=".str_replace(" ","_",$current_clerk->vars['name'])."&pg=dv"; ?>
<? echo file_get_contents("https://www.costaricaanimalrescuecenter.org/utilities/ui/day-visits/list.php?p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING'].$data.$search_criterias.$pagenumber); ?>
