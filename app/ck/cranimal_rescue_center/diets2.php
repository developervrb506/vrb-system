...
$search_criterias = "&date=".$date."&page=".$page;
?>
<div class="page_content" style="padding-left:10px;">
<? echo @file_get_contents("https://www.costaricaanimalrescuecenter.org/utilities/ui/volunteers/diets2.php?&p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING'].$search_criterias); ?>
