...
<? set_time_limit(0); ?>
<? if(!$current_clerk->im_allow("just_queue_calls")){include(ROOT_PATH . "/ck/process/admin_security.php");} ?>
<?
...
<? // Just for Hollywood calls ?>
<form action="calls_external.php" method="post" id="form_search">
...
if ($no_login){
  ...
  // THIS USE  COMMENTED FUNCTION ON HANDLER
