...
<input name="l" type="hidden" id="" value="-1" />
<br /><br />
<input name="sent" type="submit" id="sent" value="Search" />
</form>

<? } ?>
<?  //echo"http://www.sportsbettingonline.ag/utilities/process/reports/import_props_new.php?kw=".urlencode($keywords)."&b=".$book."&s=".$sport."&l=".$league."&e=".$extra; ?>
<? if($book != "") { ?>
<? echo file_get_contents("http://www.sportsbettingonline.ag/utilities/process/reports/import_props_test.php?kw=".urlencode($keywords)."&b=".$book."&s=".$sport."&l=".$league."&e=".$extra); ?>
<? } ?>
...
<script type="text/javascript">
 ...
 function reload_page(){
 	...
 	window.location.href = "http://localhost:8080/ck/import_props_test.php?book="+book;
 	//alert(book);
 }
