...
<? if($current_clerk->im_allow("prepaid_payouts")){ ?>
<?
$from = post_get("from");
...
<span class="page_title">Prepaid Gift Card Payouts</span>
<?php /*?><br /><br />
<form method="post">
...
<? 
$trans = search_prepaid_payouts($from, $to, $status, "ac");
$players = "";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td class="table_header" align="center">Card Type</td>
    <td class="table_header">Send to</td>
  ...
  <tr>
    <td class="table_td<? echo $style ?>" align="center">
		...
		<img id="umki_<? echo "PTP" . $tran->vars["id"] ?>" src="https://www.ezpay.com/images/icons/important_vrb.png" width="20" height="20" alt="/" title="Insert Payout">
		</a>
		<img id="mki_<? echo "PTP" . $tran->vars["id"] ?>" src="https://www.ezpay.com/images/icons/complete_vrb.png" width="20" height="20" alt="/" title="Paid" style="display:none;">
    </td>
    ...
    <td class="table_td<? echo $style ?>" align="center"><? echo $tran->vars["card_type"]; ?></td>
    <td class="table_td<? echo $style ?>"><? echo $tran->vars["send_info"]; ?></td>
    ...
    <td class="table_td<? echo $style ?>" align="center">
    	<form method="post" action="process/actions/deny_prepaid_payout.php" onsubmit="return confirm('Are you sure you want to Deny this Payout?')">
