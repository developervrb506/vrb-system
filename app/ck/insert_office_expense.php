...
<? $expense = get_office_expense($_GET["ex"]); ?>
<? 
?>
...
<div class="form_box">
    	...
    	<form method="post" onsubmit="return validate(validations)" action="process/actions/insert_office_expense_action.php" id="frm_ex" >
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="10">          
      ...
      <tr>
		<td>Amount:</td>
		<td>
			<input name="amount" <? if(!is_null($expense)){ ?> readonly="readonly" disabled="disabled" <? } ?> type="text" id="amount" value="<? echo str_replace("-","",$expense->vars["amount"]) ?>" />
		</td>
	  </tr>
      <tr>
		<td>Month/Year:</td>
      ...
      <tr>
		<td>Moneypak</td>
		<td>
			<input name="moneypak" type="checkbox" id="moneypak" value="1" />
		</td>
	  </tr> 
	  <tr>
		<td>Note</td>
