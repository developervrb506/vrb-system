...
<div class="form_box" id="form_div_broad" style="display:none">
    <script type="text/javascript">
    var validations = new Array();
  	validations.push({id:"department2",type:"null", msg:"Department is required"});
	validations.push({id:"subject2",type:"null", msg:"Subject is required"});
	validations.push({id:"msg2",type:"null", msg:"Message is required"});
    </script>
    <div align="center">
