...
<? $expense = get_predefined_office_expense($_GET["ex"]); ?>
<? 
?>
...
<span class="page_title">Insert Predefined Expense</span><br /><br />
<div class="form_box">

    	<form method="post" onsubmit="return validate(validations)" action="process/actions/insert_predefined_office_expense_action.php" id="frm_ex" >
