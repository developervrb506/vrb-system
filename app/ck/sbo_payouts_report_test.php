...
<script type="text/javascript" src="<?= BASE_URL ?>/ck/includes/js/functions.js"></script>
...
echo file_get_contents("http://www.sportsbettingonline.ag/utilities/process/reports/vrb_payouts_report_test.php".$data); 
echo "<br /><br />";
