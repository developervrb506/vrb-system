...
<span class="page_title">Insert Manual Reloadit</span><br /><br />
<div class="form_box">
	<form method="post" onsubmit="return validate(validations)" action="process/actions/insert_manual_reloadit.php" target="_parent">
