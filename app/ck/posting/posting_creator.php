...
$sftp = new Net_SFTP('gn409.whpservers.com',22);
...
if ($brand == 8 or $brand == 6){
	$header = file_get_contents($bookname["url"].'utilities/ui/web/header.php');
}else{
...
if ($brand == 8){
	...
	$body1 = '<div class="main_container">
                 <div class="container-internal container-fluid">
                    <div class="row">
                       <div class="col-sm-12">';
...
$body1 .= '<div class="content1_main">
    ...
    <br />
    <hr size="1">
    <div class="fb-share-button" data-href="'.$slug.'" data-layout="button_count"></div> <br><br> <a href="https://twitter.com/share" class="twitter-share-button" data-via="SportsBettingOn">Tweet</a>';
...
if ($brand == 8 or $brand == 6){	
   $footer .= file_get_contents($bookname["url"].'utilities/ui/web/footer.php');
}else{
