...
<? echo @file_get_contents("https://www.volunteertours.com/utilities/ui/newsletter_subscriptions/list.php?&p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING'].$data.$search_criterias.$pagenumber); ?>
