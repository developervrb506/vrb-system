...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td class="table_td<? echo $style ?>" align="center">
		...
		?>
		<a href="http://localhost:8080/ck/<? echo $url ?>?mts=<? echo $key ?>&free=<? echo file_get_contents("http://www.sportsbettingonline.ag/utilities/process/reports/is_mp_payout_free.php?ptpid=".$tran->vars["id"]); ?>" class="normal_link" rel="shadowbox;height=370;width=600">
