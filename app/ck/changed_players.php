...
<?  require_once ("../includes/menu_ck.php"); ?>
...
<br /><br />
	...
	<? 
	echo file_get_contents("http://www.sportsbettingonline.ag/utilities/process/reports/changed_players.php?pass=VrBAcc@ess&from=$from&to=$to");
	
 /*
	 $content = @file_get_contents("http://www.sportsbettingonline.ag/utilities/process/reports/changed_players.php?pass=VrBAcc@ess&from=$from&to=$to");
