...
$caccounts = get_all_pph_accounts();
$adjusted_balances = get_adjusted_balances("a","pph");
?>
...
<tr>
  ...
  <td class="table_td<? echo $style ?>" align="center" title="<? echo $adjusted_balances[$cacc->vars["name"]]->vars["note"] ?>">
  	<a href="adjust_balance.php?t=a&s=pph&a=<? echo $cacc->vars["name"] ?>" class="normal_link" rel="shadowbox;height=310;width=400">
