...
<thead>
  <tr>
    ...
    <th class="table_header" scope="col" nowrap="nowrap"><strong>Password</strong></th>
    <th class="table_header" scope="col" nowrap="nowrap"><strong>The applicant's Website URL</strong></th>
    <?php /*?><th class="table_header" scope="col" nowrap="nowrap"><strong>Sportsbook</strong></th><?php */?>
...
<tbody id="the-list">
  ...
  <tr>
    ...
    <th class="table_td<? echo $style ?>"><? echo aff_two_way_encript($pend->vars["nepass"], true);  ?></th>
    <th class="table_td<? echo $style ?>"><? echo $pend->vars["websiteurl"] ?></th>
    <?php /*?><th class="table_td<? echo $style ?>"><? echo $books[$pend->vars["idbook"]]->vars["name"]; ?></th><?php */?>
    <?php /*?><th class="table_td<? echo $style ?>"><a href="partners_approve_details.php?affid=<? echo $pend->vars["id"]; ?>&bookid=<? echo $pend->vars["idbook"]?>">Approve</a></th>    <?php */?>
    <th class="table_td<? echo $style ?>"><a href="partners_approve_details.php?affid=<? echo $pend->vars["id"]; ?>">Approve</a></th>    
