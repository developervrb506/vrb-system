<?php include("C:/websites/jobs.inspin.com/includes/header.php");?>
...
<div class="box_content_right_interna_contest">  
   <? $banner_id = "contest";
	  	 include("C:/websites/jobs.inspin.com/includes/banners/index.php"); ?>
   <? if (is_on_air($contest->open_date, $contest->close_date) && $contest->visible){ ?>
        ...
        <div class="question_background<? echo $style ?>">
                    	...
                    	<div class="question_text_content">
                            ...
                            <!--Questions Edit Content-->
							  ...
							  ?>
                                ...
                                <td width="5"><? if($current_customer->vars["premium"]){ ?><input name="radio_<? echo $question->id ?>" type="radio" id="radio_<? echo $question->id ?>" value="<? echo $answ->id ?>" <? if(is_answer_select_by_customer($answ->id, $current_customer->vars["id"])){echo " checked";} if($fill){echo ' disabled="disabled"';}  ?>  ><? } ?></td>
          ...
          <? } ?>
          <div class="submit_btn_div_contest"><? if(!$fill){ if($current_customer->vars["premium"]){?> 
...
<?php include("C:/websites/jobs.inspin.com/includes/footer.php"); ?>