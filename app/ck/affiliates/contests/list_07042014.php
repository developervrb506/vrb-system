...
<div class="box_content_right_interna_contest">  
    <div><?php include('C:/websites/jobs.inspin.com/contests/body-text.php'); ?></div>   
   <? $banner_id = "contest";
                    ...
                    ?>
                    	<tr class="contetn_title_box_list" style="background:#<? echo $style ?>;">
                          <td class="contetn_title_box_list_cell"><ul class="ul_contest_content">
                            <li>
                            	<a style="text-decoration:none" href="<? echo $url_contest ?>"><? echo $contest->name ?></a>
                            </li>
                          </ul></td>
                          ...
                          <td width="100" class="contetn_title_box_list_cell_click">
                          	<a style="color:#000; font-size:12px;" class="links_azul_triangulito_der" href="<? echo $url_contest ?>">Click Here</a>
                          </td>
                        </tr>                                                
          			<? } ?>
                   	</table>
