...
<thead>
  <tr>
    ...
    <th class="table_header" scope="col" nowrap="nowrap"><strong>OWI</strong></th>
    <th class="table_header" scope="col" nowrap="nowrap"><strong>PBJ</strong></th>
    <th class="table_header" scope="col" nowrap="nowrap"><strong>BB</strong></th>
    <th class="table_header" scope="col" nowrap="nowrap"><strong>HRB</strong></th>
    <th class="table_header"  scope="col" nowrap="nowrap"><strong>BETLION365</strong></th>
 ...
 foreach($affiliates as $aff){ ?>
    ...
    ?>   
      <tr>
        ...
        <th class="table_td<? echo $style ?>" ><? echo $aff_code[$books["owi"]."_".$aff->vars["id"]]["affiliatecode"];  ?></th>
        ...
        <th class="table_td<? echo $style ?>" ><? echo $aff_code[$books["betlion"]."_".$aff->vars["id"]]["affiliatecode"];  ?></th>        
