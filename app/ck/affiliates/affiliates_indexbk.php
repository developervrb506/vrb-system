...
<? if($current_clerk->im_allow("affiliate_descriptions")){ ?>             
  <tr>
      <td width="50%">
        <a class="normal_link" href="<?= BASE_URL ?>/ck/affiliates_description.php">AF Comments</a><br />
 ...
 <? if($current_clerk->im_allow("agent_freeplays")){ ?>
  <tr>
      <td width="50%">
        <a class="normal_link" href="<?= BASE_URL ?>/ck/agent_freeplays.php">AF Freelays</a><br />
 ...
 <? if($current_clerk->im_allow("affiliate_leads")){ ?>
  <tr>
      <td width="50%">
        <a class="normal_link" href="<?= BASE_URL ?>/ck/affiliates_leads.php">AF Leads</a><br />
  ...
  <tr>
      <td width="50%">
        <a class="normal_link" href="<?= BASE_URL ?>/ck/affiliates/partners_campaignes.php">Manage Campaigns </a><br />
  ...
  <tr>
      <td width="50%">
        <a class="normal_link" href="<?= BASE_URL ?>/ck/affiliates/partners_affiliates.php">Manage Partners</a><br />
  ...
  <tr>
      <td width="50%">
        <a class="normal_link" href="<?= BASE_URL ?>/ck/affiliates/partners_search_ids.php">Search by Id</a><br />
