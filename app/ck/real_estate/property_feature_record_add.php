...
<title>Add property feature</title>
...
$src = "https://www.costaricanproperties.com/admin/property_features/add.php?n=".$security_number."&p=".$security_param."&".$error."&".$_SERVER['QUERY_STRING']."&".mt_rand();
