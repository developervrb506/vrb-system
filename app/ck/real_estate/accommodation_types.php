...
<title>ACCOMMODATION TYPES</title>
...
$src = "https://www.costaricanproperties.com/admin/accommodation_types/list.php?&n=".$security_number."&p=".$security_param."&".$error."&".$_SERVER['QUERY_STRING']."&".mt_rand();
