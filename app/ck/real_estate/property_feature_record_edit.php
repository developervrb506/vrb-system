...
<title>Edit property feature</title>
...
$src = "https://www.costaricanproperties.com/admin/property_features/edit.php?n=".$security_number."&p=".$security_param."&".$error."&".$_SERVER['QUERY_STRING']."&".mt_rand();

?>

<iframe width="100%" height="2300" frameborder="0" scrolling="yes" src="<? echo $src ?>" id="foo"></iframe>
