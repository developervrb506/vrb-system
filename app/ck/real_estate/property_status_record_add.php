...
<title>Add property status</title>
...
$src = "https://www.costaricanproperties.com/admin/property_statuses/add.php?n=".$security_number."&p=".$security_param."&".$error."&".$_SERVER['QUERY_STRING']."&".mt_rand();
