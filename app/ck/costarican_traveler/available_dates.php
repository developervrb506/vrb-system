...
echo @file_get_contents("https://www.costaricantraveler.com/utilities/ui/available_dates/list.php?&p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING'].$id.$add); ?>
