...
echo @file_get_contents("https://www.costaricantraveler.com/utilities/ui/itineraries/list.php?&p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING'].$id.$add.$data); ?>
