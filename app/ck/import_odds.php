...
<input name="book" type="hidden" id="a" value="<? echo $book; ?>" />
<input name="l" type="hidden" id="b" value="-1" />
<br /><br />
...
<? if($book != "") { ?>
<? //echo "http://www.sportsbettingonline.ag/utilities/process/reports/import_odds_new.php?kw=".urlencode($keywords)."&b=".$book."&s=".$sport."&l=".$league."&e=".$extra; 
 echo @file_get_contents("http://www.sportsbettingonline.ag/utilities/process/reports/import_odds_new.php?kw=".urlencode($keywords)."&b=".$book."&s=".$sport."&l=".$league."&e=".$extra); ?>
<? } ?>
...
<script type="text/javascript">
 ...
 function reload_page(){
 	...
 	window.location.href = "http://localhost:8080/ck/import_odds.php?book="+book;
 	//alert(book);
 }
...
<? echo file_get_contents("http://www.sportsbettingonline.ag/utilities/process/reports/import_odds_new.php?kw=".urlencode($keywords)); ?>
