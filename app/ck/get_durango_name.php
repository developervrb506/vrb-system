...
<span class="page_title">Durango Name</span><br /><br />
<div class="form_box">

<? if (!is_null($durango)){ ?>

 <form method="post" action="process/actions/durango_update_control_action.php" id="frm_ex" >

 <table width="100%" border="0" cellspacing="0" cellpadding="10">          
   <tr>
     <td width="29%">First Name</td>
      <td width="71%">
        <input name="type" type="hidden" id="type" value="durango" />
