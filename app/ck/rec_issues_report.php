...
<span class="page_title">Rec Issues Report</span><br /><br />
...
<select name="status" id="status">
  ...
  <option value="so" <? if($status == "so"){echo 'selected="selected"';} ?>>Resolved</option>
...
<?
    $tickets = search_rec_issues_tickets($from, $to, $status, $agent,$admin);
?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
       ...
       <? } ?>
        <td class="table_td<? echo $style ?>" align="center">
        	<a href="rec_issues.php?detail&tid=<? echo $tik->vars["id"]; ?>&close=1" class="normal_link">View</a>
        </td>
      </td>
  <? } ?>
  <tr>
