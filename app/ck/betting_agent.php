...
if(isset($_GET["detail"])){
	//details
	$agent = get_betting_agent($_GET["acc"]);
	if(is_null($agent)){
		$title = "Add new Agent";
	}else{
		$title = "Edit Agent";
	...
	<div class="form_box" style="width:400px;">
        <form method="post" action="betting_agent.php?e=41" onsubmit="return validate(validations)">
	...
	//list
	?>
    <span class="page_title">Betting Agents</span><br /><br />
    <a href="?detail" class="normal_link">+ Add Agent</a><br /><br />
	<? include "includes/print_error.php" ?>    
