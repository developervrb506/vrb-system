...
<title>Auto Betting Accounts</title>
...
if(isset($_GET["detail"])){
    ...
    <a href="autobet/place_auto_bet.php" class="normal_link">Basic Mode</a>   
    &nbsp;&nbsp;|&nbsp;&nbsp;<a href="autobet/sum_mode.php" class="normal_link">Pro Mode</a>
   <?php /*?> <a href="?detail" class="normal_link">+ Add Account</a><br /><br /><?php */?>
	<? include "includes/print_error.php" ?>    
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <?
	  $i=0;
	   $accounts = get_all_auto_betting_accounts();
