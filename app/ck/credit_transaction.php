...
validations.push({id:"credit_account_list_from",type:"null", msg:"Please select an Account"});
validations.push({id:"credit_account_list_to",type:"null", msg:"Please select an Account"});
...
<span class="page_title">Insert Credit Transaction</span><br /><br />
<div class="form_box">
	<form action="process/actions/insert_credit_action.php" method="post" target="_parent" onsubmit="return validate(validations)" >
