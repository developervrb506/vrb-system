...
<title>Moneypaks waiting Deposits</title>
...
<span class="page_title">Paks waiting Deposits</span>
<br /><br />
<? 
$trans = array_reverse(get_waiting_mp_payouts()); 
$player_list = array();
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td class="table_header" align="center">NET W/L</td>
  ...
  <tr>
    ...
    <td class="table_td2<? echo $extra_stl; ?>" align="center"><? echo $tran->vars["id"]; ?></td>
    <td class="table_td2<? echo $extra_stl; ?>" align="center"><? echo $tran->str_method(); ?></td>
    <td class="table_td2<? echo $extra_stl; ?>" align="center"><? echo $tran->vars["player"]; ?></td>
    <td class="table_td2<? echo $extra_stl; ?>" align="center"><? //@eval("echo \$nets->".$tran->vars["player"]."->net;"); ?></td>
    <td class="table_td2<? echo $extra_stl; ?>" align="center"><? echo $tran->vars["amount"]; ?></td>
    <td class="table_td2<? echo $extra_stl; ?>" align="center"><? echo $tran->vars["fees"]; ?></td>
    <td class="table_td2<? echo $extra_stl; ?>" align="center"><? echo $tran->vars["tdate"]; ?></td>
    <td class="table_td2<? echo $extra_stl; ?>" align="center"><? echo $tran->get_destination(); ?></td>
    <td class="table_td2<? echo $extra_stl; ?>" align="center"><? echo nl2br($tran->vars["comments"]); ?></td>
    <td class="table_td2<? echo $extra_stl; ?>" align="center">
    	<? if(!$inserted){ ?>
    	<form method="post" action="process/actions/reject_waiting_mp_payout.php" onsubmit="return confirm('Are you sure you want to Reject this payout?');">
            <input name="pid" type="hidden" id="pid" value="<? echo $tran->vars["id"] ?>" />
            <input name="Enviar" type="submit" value="Reject" />
        </form>
        <? } ?>
    </td>
  </tr>
