...
$data_clerk = "&cid=".$current_clerk->vars['id']."&clerk=".str_replace(" ","_",$current_clerk->vars['name'])."&pg=d";
...
$src = "http://www.rescuecenter.org/admin/donations/list.php?&n=".$security_number."&p=".$security_param."&".$error."&".$_SERVER['QUERY_STRING'].$data_clerk;

?>
 <iframe width="100%" height="1300px" frameborder="0" scrolling="yes" src="<? echo $src ?>" id="foo"></iframe>  
</div>
