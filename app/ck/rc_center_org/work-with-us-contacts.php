...
<title>WORK WITH US CONTACTS</title>
...
$src = "http://www.rescuecenter.org/admin/work_with_us_contacts/list.php?&n=".$security_number."&p=".$security_param."&".$error."&".$_SERVER['QUERY_STRING'];
