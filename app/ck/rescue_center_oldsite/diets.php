...
$search_criterias = "&date=".$date;
?>
<div class="page_content" style="padding-left:10px;">
<? echo @file_get_contents("http://www.rescuecenter.com/oldsite/admin/diets.php?&p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING'].$search_criterias); ?>
</div>
