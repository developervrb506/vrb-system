...
<?
 ...
 echo file_get_contents("http://cashier.vrbmarketing.com/admin/deposits.php?c=2002&p=PRXniq92iewoie2112ias&allow_blacks=".$current_clerk->im_allow("accept_blacklist_deposit")."&".$_SERVER['QUERY_STRING']); ?>
