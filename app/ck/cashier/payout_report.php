...
<? echo file_get_contents("http://cashier.vrbmarketing.com/admin/payout_report.php?c=2002&p=PRXniq92iewoie2112ias&".$_SERVER['QUERY_STRING']."&deny_negative_payout=".$current_clerk->im_allow("deny_negative_payout")); ?>
