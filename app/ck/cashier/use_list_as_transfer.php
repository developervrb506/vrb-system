...
<form method="post" action="../process/actions/insert_intersystem_by_list_action.php" target="_parent" id="frm_<? echo $tid ?>" >
    ...
    <input name="amount" type="hidden" id="amount" value="<? echo $amount; ?>" />
  	<input name="boxes" type="hidden" id="boxes" value="<? echo $list ?>" />
