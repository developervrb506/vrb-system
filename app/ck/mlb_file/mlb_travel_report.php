...
<img src="images/MLB.png" style="width:60px; margin-bottom:-20px"><span class="page_title">TEAMS TRAVEL REPORT</span><br /><br /><br />
<?	

if($current_clerk->vars['id'] != 86 ){
	$subject = 'MLB REPORT ACCESS';
