...
<script type="text/javascript" src="http://localhost:8080/ck/nba_file/js/functions.js"> </script>
...
<img src="images/NBA.png" style="width:60px; margin-bottom:-20px"><span class="page_title">TEAMS TRAVEL REPORT</span><br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span> Show the information for the next Game after the # of Away Days </span><br /><br />
<?	

if($current_clerk->vars['id'] != 86 ){
	$subject = 'NBA REPORT ACCESS 2';
...
if ($str_teams == "" && $other != "" ){?>
 ...
 foreach($selected_teams as $steam){
    ...
    <div>
       <img style="width:35px" src="http://localhost:8080/ck/nba_file/images/<? echo $teams[$st]->vars["logo"]?>.png">
