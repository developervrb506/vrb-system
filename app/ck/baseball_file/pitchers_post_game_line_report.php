...
?>
	...
	<tr>
	 ...
	 <td class="table_td<? echo $style ?>" style="font-size:12px; <? echo $bgk_h ?>"><? echo $pitcher_home->vars["player"]; if ($this_team == "home") { echo "( ".$game->vars[$game->vars[id]."_".$game->vars["pitcher_home"]]." )"; } ?></td>     <td class="table_td<? echo $style ?>" style="font-size:12px;"><? echo $game->vars["rest_time"] ?></td>        
