...
foreach ($games as $game){
	  ...
	  get_player_statistics_old($player_a->vars["fangraphs_player"],$player_a->vars["position"],$player_a->vars["player"],$game->vars["id"],$year);
	  ...
	  get_player_statistics_old($player_h->vars["fangraphs_player"],$player_h->vars["position"],$player_h->vars["player"],$game->vars["id"],$year);
	  echo "<BR>--<BR>";
	// break; 
} 

function get_player_statistics_old($playerid,$position,$player_name,$gameid,$year){
