...
foreach ($games as $game){
    ...
    if ($game->vars["pitcher_home"]){
      ...
      get_player_era($player_h->vars["fangraphs_player"],$player_h->vars["player"],$year,false,$game->vars["id"]); 
	}
$i++;
		...
		//} //
		 ...
		 if (!$last_season){
		   ...
		   $statistics->update(array("season","rest_time","total_last_game","avg_last_games","sum_last_games","avg_season","avg_last_four_games","sum_last_four_games","avg_last_five_games","sum_last_five_games","avg_last_two_games","sum_last_two_games")); 
			...
			//  $statistics->update(array("avg_last_four_games","sum_last_four_games","avg_last_five_games","sum_last_five_games")); 
