...
<table id="baseball" width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td name="weather_stadistics" width="120" class="table_header">MoistA</td> 
     <td name="weather_stadistics" width="120" class="table_header">Aird</td>             
  </tr>
...
<?
 ...
 foreach($games as $game){
	...
	// echo $air_density."  -  ".$water_vapour." - ".$temp_kelvin." <BR>";
 ...
 <? //weather  ?>    
  ...
  <td name="weather_stadistics" class="table_td<? echo $style.$weather_style ?>" style="font-size:12px;" id="air_dd<? echo $game->vars["id"]?>">
	 	<? echo $aird ?>
     </td> 
