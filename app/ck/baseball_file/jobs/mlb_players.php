...
foreach ($team as $_team){
   ...
   $html = file_get_html("http://www.fangraphs.com/leaders.aspx?pos=all&stats=pit&lg=all&qual=0&type=0&season=".$year."&month=0&season1=".$year."&ind=0&team=".$_team["fangraphs_team"]."&players=0"); 
   echo "http://www.fangraphs.com/leaders.aspx?pos=all&stats=pit&lg=all&qual=0&type=0&season=".$year."&month=0&season1=".$year."&ind=0&team=".$_team["fangraphs_team"]."&players=0";  
 ?>
  <BR> <BR>
