...
// THIS JOB IS OBSOLET AND IS NOT BEING USED now used fantasy AWAY and HOME
...
$players = get_players_by_date_pending_update($today,$type);
...
function fantasy_espn_data($player){ 
  ...
  $data = array();
   ...
   foreach($html->find('div[id="fantasy-content"]') as $element) {    
