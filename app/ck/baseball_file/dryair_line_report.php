...
validations.push({id:"dry1",type:"numeric", msg:"Please use only Numbers"});
validations.push({id:"dry2",type:"numeric", msg:"Please use only Numbers"});
</script>
...
<span class="page_title">Dry Air Line Report
</span><br /><br />
...
<form method="post" onsubmit="return validate(validations)">
    ...
    &nbsp;&nbsp;
    Dry Air (range): &nbsp;&nbsp; <input name="dry1" type="text" id="dry1" value="<? echo $_POST["dry1"] ?>" style="width:40px"  align="middle" />  &nbsp;&nbsp;  to &nbsp;<input name="dry2" type="text" id="dry2" value="<? echo $_POST["dry2"] ?>" style="width:40px"  align="middle" /> 
   <Br/ ><Br/ ><Br/ >
    &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
     ...
     <? } ?> 
       <td >
        ...
        <?
		 ...
		 if ((!isset($_POST["dry1"])) && $stadium->vars["team_id"]!=37)  {
...
<? if (isset($_POST["dry1"])){
   ...
   <? }
	   ...
	   $games = get_baseball_games_by_dryair($from,$to,$_POST['condition'],$_POST['dry1'],$_POST['dry2'],$str_stadiums);
	   $show_table = true;
	  if (empty($games)){
	  ...
	  if ($show_table) {
		...
		<table id="baseball" width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<td  name ="game_info_" width="90"  class="table_header">Dry Air</td>
