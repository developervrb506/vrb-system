...
//Just to pull the info of last 5 years
$year_base = date("Y") - 2014;
for($i = 0;$i<=$year_base;$i++){
...
<span class="page_title">Umpire Stadistics Report  
		...
		<table id="sortable_table_umpire" class="sortable"  width="100%" border="0" cellspacing="0" cellpadding="0">
		 <thead>
          <tr>
          ...
          <tbody id="the-list">
			...
			<?
              ...
              foreach ($umpires as $umpire) {
                ...
                <td width="60" class="table_td<? echo $style ?>" style="font-size:12px;"><? echo $ump_data[$umpire->vars["id"]."_".$year["year"]]["k_bb"]?></td> 
                 ...
                 <?
				  ...
				  $t_weigted_avg = $t_weigted_avg + $weigted_avg;
				   ...
				   if( $umpire->vars["umpire"] == "ESTABROOK M"){
				      echo "$this_year --  $weigted_avg /"; 
				   }
                ...
                //  print_r($avg);
				//	 echo "<BR>";
				//	 if(  $umpire->vars["umpire"] == "BARRETT L") {exit;}
