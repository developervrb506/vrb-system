...
<span class="page_title">Wheather Line Report
</span><br /><br />
     ...
     ?>
      ...
      <? } 
        ...
        <span><strong>Stadium:  </strong> <? echo strtoupper($_stadium->vars["name"]) ?></span><BR><BR>
				  <?  
 		 print_wheater_line($from,$to,$_stadium->vars["team_id"],$_POST["factor"],$indoors,$_POST["range1"],$_POST["range2"],$lines_game,$higher);
