			...
			<?
              ...
              foreach ($umpires as $umpire) {
                ...
                <? } ?>
                 ...
                 <td class="table_td<? echo $style ?>" style="font-size:12px;"><? echo number_format((+$kbb_2 - $t_avg),2) ?></td>                  
				 <td class="table_td<? echo $style ?>" style="font-size:12px;"><? echo number_format((+$kbb_1 - $t_avg),2) ?></td>                  
