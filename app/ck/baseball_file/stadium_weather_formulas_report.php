...
if($current_clerk->im_allow("baseball_file")){ ?>
  ...
  <span class="page_title">Weather Formulas Report
  </span><br /><br />
  ...
  <? if (isset($_POST["stadium"])){ ?>
         ...
         <?
         $min_games = get_baseball_games_weather_stadium($_POST["factor"],$_POST["stadium"],$from,$to,"ASC",$_POST["indoors"]);
         $total_runs = 0 ;
         $total_homeruns = 0 ;
          ?>
        ...
        <table id="baseball" width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <? } ?>
           <tr>
            ...
            <tr>
              ...
              <td class="table_header"><strong><? echo number_format(($total_homeruns/10),2);?></strong></td>  
              <td class="table_header"><strong><? echo number_format(($total_runs/10),2);  ?></strong></td>  
            </tr>
         ...
         <? 
         $avg_data = get_baseball_avg_data_stadium($_POST["factor"],$_POST["stadium"],$from,$to,$date_end,$_POST["indoors"]);
         ?>
         <br /><br />
        ...
        <?
         $max_games = get_baseball_games_weather_stadium($_POST["factor"],$_POST["stadium"],$from,$to,"DESC",$_POST["indoors"]);
         $total_runs = 0;
         $total_homeruns = 0;
        ?>
