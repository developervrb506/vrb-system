...
<table  id="baseball" name="baseball" width="<? echo $table_width ?>" border="0" cellspacing="0" cellpadding="0">
 ...
 <th width="6" name="show_weather_stadistics" class="table_header" title="Show Weather Stadistics"  ><img src="images/next.png" onClick='show_hide_column( "baseball","weather_stadistics",true,10);show_hide_column( "baseball","show_weather_stadistics",false,0);show_hide_column( "baseball","hide_weather_stadistics",true,0)' > </th>   
   ...
   <th width="6" name="hide_weather_stadistics" class="table_header" title="Hide Weather Stadistics"><img src="images/previous.png" onClick='show_hide_column( "baseball","weather_stadistics",false,10);show_hide_column( "baseball","hide_weather_stadistics",false,0);show_hide_column( "baseball","show_weather_stadistics",true,0)' > </th>   
    ...
    <th width="6" name="show_groundball_stadistics" class="table_header" title="Show Groundball Stadistics"  ><img src="images/next.png" onClick='show_hide_column( "baseball","groundball_stadistics",true,2);show_hide_column( "baseball","show_groundball_stadistics",false,0);show_hide_column( "baseball","hide_groundball_stadistics",true,0)' > </th>    
    
    <th  name="groundball_stadistics"  width="120"  class="table_header"> GB %</th>
    <th  name="groundball_stadistics" width="120"  class="table_header"> GB %</th>  
    
    <th width="6" name="hide_groundball_stadistics" class="table_header" title="Hide Groundball Stadistics"><img src="images/previous.png" onClick='show_hide_column( "baseball","groundball_stadistics",false,2);show_hide_column( "baseball","hide_groundball_stadistics",false,0);show_hide_column( "baseball","show_groundball_stadistics",true,0)' > </th>   
  ...
  <th width="6" name="hide_bullpen_stadistics" class="table_header" title="Hide Bullpen Stadistics"><img src="images/previous.png" onClick='show_hide_column( "baseball","bullpen_stadistics",false,8);show_hide_column( "baseball","hide_bullpen_stadistics",false,0);show_hide_column( "baseball","show_bullpen_stadistics",true,0)' > </th>     
    ...
    <th name="lines_stadistics" width="120" class="table_header" align="center">MONEY 1st 5 A</th>  
    ...
    <th name="lines_stadistics" width="120" class="table_header" align="center">Team H U JUICE</th>
...
?>   
    ...
    <td name="show_groundball_stadistics" class="table_td1" ></td>   

    <td name="groundball_stadistics" class="table_td<? echo $style ?>" style="font-size:12px;">
     <table>
       <tr>
   ...
   <td name="hide_groundball_stadistics" ></td>   
...
?>
  ...
  ?>
    ...
    <td name="bullpen_stadistics" title="Bullpen PC This Season"  class="table_td<? echo $style ?>" style="font-size:12px;" id="pc_h_season<? echo $game->vars["id"]?>"><? echo $bullpen_season_h["PC"] ?></td>  
        ...
        <td name="bullpen_stadistics" title="Errors A"  class="table_td<? echo $style ?>" style="font-size:12px;" id="ip_h_season<? echo $game->vars["id"]?>"><? echo "" ?></td>
