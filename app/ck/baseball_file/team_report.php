...
$line = "";
if($year != ""){
$report_line ="Date\tHour\tAway\tHome\tHOMERUNS\tRUNS A\tRUNS H\tRUNS T\tSCORE\tSTATUS\tElev\tRoof\tRuns\tHomeRuns\tHits\t2B\t3B\tBB\tTMP\tCondition\tHM\tWS\tWD\tWP\tWG\tAirP\tDewP\tDryA\tVapourP\tMoistA\tPK\tAirD\tUmpire\t".($year-5)."\tStarts\t".($year-4)."\tStarts\t".($year-3)."\tStarts\t".($year-2)."\tStarts\t".($year-1)."\tStarts\t".($year)."\tStarts\tWeighted AVG\tPitcher\tGB %\tEra\tXFip\tEra/Diff\tK9\tRest Time\tHighest PC\tLast Game\tSum (3G)\tAvg (3G)\tSum (4G)\tAvg (4G)\tSum (5G)\tAvg (5G)\tAvg (S)\tAvg (Last S)\tFB%\tSL%\tCT%\tCB%\tCH%\tSF%\tKN%\tXX%\tSum_SCC%\tFBv (2G)\tFBv Last G.\tFBv Season\tPitcher\tGB %\tEra\tXFip\tEra/Diff\tK9\tRest Time\tHighest PC\tLast Game\tSum (3G)\tAvg (3G)\tSum (4G)\tAvg (4G)\tSum (5G)\tAvg (5G)\tAvg (S)\tAvg (Last S)\tFB%\tSL%\tCT%\tCB%\tCH%\tSF%\tKN%\tXX%\tSum_SCC%\tFBv (2G)\tFBv Last G.\tFBv Season\tBA IP\tBA PC\tBH IP\tBH PC\tIP  Total\tPC Total\tBA IP Season\tBA PC  Season\tBH IP  Season\tBH PC  Season\t+10 A\t+10 H\tMONEY A\tMONEY H\tTotal OVER\tTotal O JUICE\tTotal UNDER\tTotal U JUICE\tMONEY 1st 5 A\tMONEY 1st 5 H\tT. 0ver 1st 5 I\tT. 0. Juice 1st 5I\tT. Under 1st 5I\tT. U. Juice 1st 5I\tTeam A OVER\tTeam A O JUICE\tTeam A UNDER\tTeam A U JUICE\tTeam H OVER\tTeam H O JUICE\tTeam H UNDER\tTeam H U JUICE\t\n";
} else {
	
$report_line ="Date\tHour\tAway\tHome\tHOMERUNS\tRUNS A\tRUNS H\tRUNS T\tSCORE\tSTATUS\tElev\tRoof\tRuns\tHomeRuns\tHits\t2B\t3B\tBB\tTMP\tCondition\tHM\tWS\tWD\tWP\tWG\tAirP\tDewP\tDryA\tVapourP\tMoistA\tPK\tAirD\tUmpire\tGame Year-5\tStarts\tGame Year-4\tStarts\tGame Year-3\tStarts\tGame Year -2 \tStarts\tGame Year -1\tStarts\tGame Year\tStartst\tWeighted AVG\tPitcher\tGB %\tEra\tXFip\tEra/Diff\tK9\tRest Time\tHighest PC\tLast Game\tSum (3G)\tAvg (3G)\tSum (4G)\tAvg (4G)\tSum (5G)\tAvg (5G)\tAvg (S)\tAvg (Last S)\tFB%\tSL%\tCT%\tCB%\tCH%\tSF%\tKN%\tXX%\tSum_SCC%\tFBv (2G)\tFBv Last G.\tFBv Season\tPitcher\tGB %\tEra\tXFip\tEra/Diff\tK9\tRest Time\tHighest PC\tLast Game\tSum (3G)\tAvg (3G)\tSum (4G)\tAvg (4G)\tSum (5G)\tAvg (5G)\tAvg (S)\tAvg (Last S)\tFB%\tSL%\tCT%\tCB%\tCH%\tSF%\tKN%\tXX%\tSum_SCC%\tFBv (2G)\tFBv Last G.\tFBv Season\tBA IP\tBA PC\tBH IP\tBH PC\tIP  Total\tPC Total\tBA IP Season\tBA PC  Season\tBH IP  Season\tBH PC  Season\t+10 A\t+10 H\tMONEY A\tMONEY H\tTotal OVER\tTotal O JUICE\tTotal UNDER\tTotal U JUICE\tMONEY 1st 5 A\tMONEY 1st 5 H\tT. 0ver 1st 5 I\tT. 0. Juice 1st 5I\tT. Under 1st 5I\tT. U. Juice 1st 5I\tTeam A OVER\tTeam A O JUICE\tTeam A UNDER\tTeam A U JUICE\tTeam H OVER\tTeam H O JUICE\tTeam H UNDER\tTeam H U JUICE\t\n";
...
$ump_data = get_all_umpire_data();
	...
	$subject = 'BASEBALL FILE TEAM ACCESS';
...
<span class="page_title">Team Report 
</span><BR>
...
$games =  get_all_baseball_games_by_team($team,$year,$season['start'],$season['end']);
...
<table  class="sortable"  id="baseball"  width="100%" border="0" cellspacing="0" cellpadding="0">
 <thead>
  <tr >
    ...
    <th style="cursor:pointer;"  name="weather_stadistics" width="120" class="table_header">AirD</th>    
    ...
    <? } ?>
    <th style="cursor:pointer;"  name="umpire_stadistics" width="120" class="table_header">Weighted AVG</th>    
...
<?
 ...
 <? //weather  ?>    
     ...
     <td name="weather_stadistics" class="table_td<? echo $style.$weather_style ?>" style="font-size:12px;" id="wp<? echo $game->vars["id"]?>">
       ...
       <td name="weather_stadistics"  class="table_td<? echo $style.$weather_style ?>" style="font-size:12px;" id="dw<? echo $game->vars["id"]?>">
	 	<? echo $weather->vars["aird"] ?><? $line .= $weather->vars["aird"]."\t "; ?>
       </td> 
...
<?   
   ...
   <td  name="umpire_stadistics" class="table_td<? echo $style ?>" style="font-size:12px; color:<? echo $color ?>"><? echo $ump_data[$ump_id]["weighted_avg"] ?><? $line .= $ump_data[$ump_id]["weighted_avg"]."\t "; ?></td>
