...
$to = $_POST["to"];
if($to == ""){$to = date("Y-m-d");}
$saccount = $_POST["credit_account_list"];
?>
...
<span class="page_title">Credit Transactions</span><br /><br />
<form method="post">
...
&nbsp;&nbsp;&nbsp;
Account:
<? $all_option = true; $current_account = $saccount; include("includes/credit_account_list.php"); ?>
&nbsp;&nbsp;&nbsp;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <?
  $i=0;
   $trans = search_credit_transaction($from,$to, $saccount);
