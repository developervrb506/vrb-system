...
<title>Weather System - Create Line</title>
</head>
<body>
...
<span class="page_title"><? echo $tittle; ?> Weather System - Create game</span>
&nbsp;&nbsp;&nbsp;&nbsp;
...
<?  //echo "http://cashier.vrbmarketing.com/admin/prepaid_cards_balance.php?tp=".$tp."&new=".$new."&c=2002&p=PRXniq92iewoie2112ias&".$_SERVER['QUERY_STRING'];
  ...
  echo @file_get_contents("http://www.sportsbettingonline.ag/utilities/process/weather/create_line.php?".$_SERVER['QUERY_STRING']); ?>
