...
<span class="page_title">Import Props</span><br /><br />
...
Extra: (Sport)
<input name="e" type="text" id="e" value="<? echo $extra; ?>" />
<input name="book" type="hidden" id="book" value="<? echo $book; ?>" />
...
<? } ?>
<? // echo"http://www.sportsbettingonline.ag/utilities/process/reports/import_props_new.php?kw=".urlencode($keywords)."&b=".$book."&s=".$sport."&l=".$league."&e=".$extra;  exit; ?>
<? if($book != "") { 
  if($current_clerk->vars['id'] != 1){
   echo file_get_contents("http://www.sportsbettingonline.ag/utilities/process/reports/import_props_new.php?kw=".urlencode($keywords)."&b=".$book."&s=".$sport."&l=".$league."&e=".$extra); 
   } else {
  echo file_get_contents("http://www.sportsbettingonline.ag/utilities/process/reports/import_props_new.php?kw=".urlencode($keywords)."&b=".$book."&s=".$sport."&l=".$league."&e=".$extra."&t=1"); 
   }
} ?>
