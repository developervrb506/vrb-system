...
<title>PPH Tickets Report</title>
...
<span class="page_title">PPH Tickets Report</span><br /><br />
...
<? $tickets = search_pph_tickets($from, $to, $status, $agent); ?>
<? if(count($tickets)>0){ ?>  
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<td class="table_td<? echo $style ?>" align="center">
		<a href="pph_tickets.php?detail&tid=<? echo $tik->vars["id"]; ?>" class="normal_link">View</a>
	</td>
  </td>
  <? } ?>
  <tr>
