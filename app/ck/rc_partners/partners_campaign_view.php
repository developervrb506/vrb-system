...
<title>Manage Campaign Promos</title>
...
$src = "https://www.rescuecenterpartners.com/admin/campaigns/partners_campaign_view.php?n=".$security_number."&p=".$security_param."&".$error."&".$_SERVER['QUERY_STRING'];

?>

<iframe width="100%" height="2000px"  frameborder="0" scrolling="yes" src="<? echo $src ?>" id="foo"></iframe>
