...
<title>Add Social Media Promo Type</title>
...
$src = "https://www.rescuecenterpartners.com/admin/social-media/partners_social_media_promotypes_add.php?n=".$security_number."&p=".$security_param."&".$error."&".$_SERVER['QUERY_STRING'];
