...
<title>Edit Program Description</title>
...
$src = "https://www.rescuecenterpartners.com/admin/programs-descriptions/partners_programs_descriptions_edit.php?n=".$security_number."&p=".$security_param."&".$error."&".$_SERVER['QUERY_STRING'];
