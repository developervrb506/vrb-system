...
<title>Manage Custom Promo Types</title>
...
$src = "https://www.rescuecenterpartners.com/admin/custom_promo_types/partners_custom_promotype_view.php?n=".$security_number."&p=".$security_param."&".$error."&".$_SERVER['QUERY_STRING'];
