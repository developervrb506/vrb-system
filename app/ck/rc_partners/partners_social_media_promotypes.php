...
<title>Manage Social Media Promo types</title>
...
$src = "https://www.rescuecenterpartners.com/admin/social-media/partners_social_media_promotypes.php?&n=".$security_number."&p=".$security_param."&".$error."&".$_SERVER['QUERY_STRING'];


?>
 <iframe width="100%" height="1500px" frameborder="0" scrolling="yes" src="<? echo $src ?>" id="foo"></iframe>  
