...
<title>Manage Partners News</title>
...
$src = "https://www.rescuecenterpartners.com/admin/affiliates/partners_news.php?&n=".$security_number."&p=".$security_param."&".$error."&".$_SERVER['QUERY_STRING'];
