...
$src = "https://www.rescuecenterpartners.com/admin/endorsements/partners_endorsements_edit.php?n=".$security_number."&p=".$security_param."&".$error."&".$_SERVER['QUERY_STRING'];
