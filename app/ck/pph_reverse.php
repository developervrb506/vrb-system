...
<span class="page_title">Reverse Bill Amount</span><br /><br />
<div class="form_box">
	<form action="process/actions/insert_pph_reverse_action.php" method="post" target="_parent" onsubmit="return validate(validations)" >
