...
<title>501(c)(3) Donations</title>

</head>
<body>
<? $page_style = " width:1000px;"; ?>
...
<? $data = "&cid=".$current_clerk->vars['id']."&clerk=".str_replace(" ","_",$current_clerk->vars['name'])."&pg=d5"; ?>
<? echo @file_get_contents("https://www.rescuecenter.com/utilities/ui/donators-501-c3/list.php?&p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING'].$data.$search_criterias.$pagenumber); ?>
