...
$search_criterias = "&purchase_date=".$purchase_date."&payment_status=".$payment_status."&hear=".$hear."&id_list=".$id_list."&search=".$search."&show_all=".$show_all;
?>

<div class="page_content" style="padding-left:10px;" id="container" class='table-container'>
<? $data = "&cid=".$current_clerk->vars['id']."&clerk=".str_replace(" ","_",$current_clerk->vars['name'])."&pg=p"; ?>
<? //echo file_get_contents("URL del sitio/page.php?&p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING']); ?>
<? echo @file_get_contents("https://www.rescuecenter.com/utilities/ui/purchase/list.php?&p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING'].$data.$search_criterias.$pagenumber); ?>
