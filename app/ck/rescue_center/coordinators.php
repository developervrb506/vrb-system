...
$search_criterias = "&start_date=".$start_date."&end_date=".$end_date."&dietary_type=".$dietary_type."&payment_status=".$payment_status."&status=".$status."&hear=".$hear."&completed=".$completed."&id_list=".$id_list."&search=".$search."&show_all=".$show_all;
?>

<div class="page_content table-container" style="padding-left:10px;" id="container">
<? $data = "&cid=".$current_clerk->vars['id']."&clerk=".str_replace(" ","_",$current_clerk->vars['name'])."&pg=co"; ?>
<? //echo file_get_contents("URL del sitio/page.php?&p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING']); ?>
<? echo @file_get_contents("https://www.rescuecenter.com/utilities/ui/coordinators/list.php?&p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING'].$data.$search_criterias.$pagenumber); ?>
