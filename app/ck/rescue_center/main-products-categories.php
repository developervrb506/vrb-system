...
<title>Main Products Categories</title>
...
<h1>Main Products Categories</h1>
<?
$id  = $_GET["id"]; 
$add = $_GET["add"]; 
...
echo @file_get_contents("https://www.rescuecenter.com/utilities/ui/main-products-categories/list.php?&p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING'].$id.$add); ?>
