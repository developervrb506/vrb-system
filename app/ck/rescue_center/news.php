...
if(isset($cat_id) and !empty($cat_id)){
	$cat_id = "&cat_id=".$cat_id;
}else{
	$cat_id = "";
}

echo @file_get_contents("https://www.rescuecenter.com/utilities/ui/news/list.php?&p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING'].$id.$add.$cat_id.$pagenumber); ?>
