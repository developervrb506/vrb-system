...
<head>
<title>Watch Live Packages</title>
...
echo @file_get_contents("https://www.rescuecenter.com/utilities/ui/tools/watch-live-packages/list.php?&p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING'].$id.$add); ?>
