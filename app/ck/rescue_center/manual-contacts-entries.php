...
<script type="text/javascript" src="/ck/rescue_center/js/scripts.js?<? echo mt_rand(); ?>"></script>
<title>Manual Contacts Entries</title>
...
$search_criterias = "&send_status=".$send_status."&call_status=".$call_status."&id_list=".$id_list."&search=".$search."&show_all=".$show_all;

?>
<div class="page_content" style="padding-left:10px;" id="container" class='table-container'>
<? $data = "&cid=".$current_clerk->vars['id']."&clerk=".str_replace(" ","_",$current_clerk->vars['name'])."&pg=mc"; ?>

<? echo file_get_contents("https://www.rescuecenter.com/utilities/ui/manual_contacts_entries/list.php?p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING'].$data.$search_criterias.$pagenumber); ?>
