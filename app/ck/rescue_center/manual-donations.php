...
?>
<? echo @file_get_contents("https://www.rescuecenter.com/utilities/ui/donate/manual-donations.php?&p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING'].$id.$add.$search_criterias.$pagenumber); ?>
</div>
