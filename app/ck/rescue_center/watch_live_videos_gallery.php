...
<head>
<title>Watch Live Videos Gallery</title>
...
<h1>Watch Live Videos Gallery</h1>
<?
$id   = $_GET["id"]; 
$add  = $_GET["add"];
...
echo @file_get_contents("https://www.rescuecenter.com/utilities/ui/tools/watch-live-videos-gallery/list.php?&p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING'].$id.$add); ?>
