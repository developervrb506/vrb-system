...
?>
<div style="padding-left:10px;" id="container" class='table-container page_content'>

<? $data = "&cid=".$current_clerk->vars['id']."&clerk=".str_replace(" ","_",$current_clerk->vars['name'])."&pg=v"; ?>

<? echo file_get_contents("https://www.rescuecenter.com/utilities/ui/volunteers/list.php?p=LPasjuY65FTq3Qpld1sadm0O0I8".$_SERVER['QUERY_STRING'].$data.$search_criterias.$pagenumber); ?>
