<?
 if ( current_URL() == "http://localhost:8080/aboutus.php" ) { 
   $title = "About Us";
   $url = "http://localhost:8080/aboutus.php";
} elseif (current_URL() == "http://localhost:8080/contactus.php") { 
   $title = "Contact Us";
   $url = "http://localhost:8080/contactus.php";
} 
?>
<div class="content_left">
  <div class="box_content_304" style="margin-right:7px;">
    ...
    <div class="content_text_left">
      <? if ( $url == "http://localhost:8080/aboutus.php" ) { ?>
      ...
      <? } elseif ( $url == "http://localhost:8080/contactus.php" ) { ?>      
