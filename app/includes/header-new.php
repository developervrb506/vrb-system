...
<div class="wrapper">
<div class="top">
  <div class="logoVRB"><a href="<?= BASE_URL ?>/"><img src="../images/VRB_logo.png" width="355" height="50" border="0" /></a></div>
  <div class="wrapper_right_top">    
    <div class="login_top">
      <div class="wrapper_box_login">
        <div class="box_login">
          <form style="width:266px;" id="f1" name="f1" method="post" action="<?= BASE_URL ?>/process/login/login-process.php">
        ...
        <?php /*?><div class="joinmember"><a href="<?= BASE_URL ?>/dashboard/join.php"><img src="../images/joinmember.png" alt="Not  a member yet? Join us NOW!" width="114" height="39" border="0" /></a></div><?php */?>
      </div>
    </div>
    <div style="color:#F00; font-size:10px; margin-left:40px; margin-bottom:-15px;">
    <? if ( isset($_GET["e"]) and $_GET["e"] != "" ) { echo get_error($_GET["e"]); } ?>
    </div>
    <div class="btn_top"> <?php /*?><a class="btntop" href="<?= BASE_URL ?>/contactus.php">CONTACT US</a><?php */?> <?php /*?><a class="btntop" href="<?= BASE_URL ?>/whyvrb.php">Why VRB</a><?php */?> <?php /*?><a class="btntop" href="<?= BASE_URL ?>/aboutus.php">About Us</a><?php */?> <?php /*?><a class="btntop" href="<?= BASE_URL ?>/">Home</a><?php */?> </div>
  </div>
</div>
