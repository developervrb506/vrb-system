...
<? if(in_string(this_page(),"vrbprocessing.com")){ ?>
		<div>
            ...
            <div class="phone"><?php /*?><a style="color:#FFF; text-decoration: none;" href="" onclick="Javascript:window.open('http://localhost:8080/livehelp/request_email.php?l=admtop&amp;x=1&amp;deptid=5','livehelp','width=530,height=410,menubar=no,location=no,resizable=yes,scrollbars=yes,status=no');return(false);" target="_top"><img src="../images/temp/call_processing.png" width="317" height="64" border="0" /></a><?php */?></div>
...
<? }else{ ?>
		<div><a href="http://localhost:8080" title="VRB Marketing Consultants" id="logo">VRB Marketing Consultants</a></div>
        <div class="phone"><?php /*?><a style="color:#FFF; text-decoration: none;" href="" onclick="Javascript:window.open('http://localhost:8080/livehelp/request_email.php?l=admtop&amp;x=1&amp;deptid=1&amp;agsite=vrb','livehelp','width=530,height=410,menubar=no,location=no,resizable=yes,scrollbars=yes,status=no');return(false);" target="_top"><img src="http://localhost:8080/images/temp/call.png" width="148" height="64" border="0" /></a><?php */?></div>
        <? session_start(); if($_SESSION['ckloged']){ ?>
        <?php /*?><iframe height="1" width="1" frameborder="0" scrolling="no" src="http://localhost:8080/ck/includes/popup_maker.php"></iframe><?php */?>
        <? } ?>
<? } ?>
</div>
<?
...
if (!is_null($current_clerk) && false) {
	...
	if($current_clerk->im_allow("alerts")){
		...
		if(!$noalerts){
			...
			?> 
			<script type="text/javascript">
			file_get_contents('http://localhost:8080/ck/cashier/alerter.php','alerter');
			setInterval("file_get_contents('http://localhost:8080/ck/cashier/alerter.php','alerter');",60000)
			</script>
			 <?
		}
	}
